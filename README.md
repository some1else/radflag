...
RadFlag compares your recent system load against an established baseline and also watches for any process that keeps burning more CPU than your configured limit for five straight minutes. The goal is to catch runaway plugins, render loops, and polling storms before they ruin your remaining battery life.
...
Click the icon to see current stats (5-minute load, baseline, ratio, top process, trigger reason, power source) and access controls:
